...
data class FhMdTypographyStyle(
...
data class FhMdThematicBreakStyle(
    val color: Color = Color(0xFFD0D7DE),
    val thickness: Dp = 1.dp,
)

data class FhMdImageStyle(
    val shape: Shape = RoundedCornerShape(8.dp),
...
data class FhMdStyle(
    val typography: FhMdTypographyStyle = FhMdTypographyStyle(),
    val inline: FhMdInlineStyle = FhMdInlineStyle(),
    val layout: FhMdLayoutStyle = FhMdLayoutStyle(),
    val quote: FhMdQuoteStyle = FhMdQuoteStyle(),
    val code: FhMdCodeBlockStyle = FhMdCodeBlockStyle(),
    val table: FhMdTableStyle = FhMdTableStyle(),
    val thematicBreak: FhMdThematicBreakStyle = FhMdThematicBreakStyle(),
    val image: FhMdImageStyle = FhMdImageStyle(),
) {
